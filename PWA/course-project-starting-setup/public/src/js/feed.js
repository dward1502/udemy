...
locationButton.addEventListener('click', function(event) {
  ...
  navigator.geolocation.getCurrentPosition(function(postion){
    ...
    fetchedLocation = postion. coords.latitude;
    locationInput.value = 'In San Diego';
...
captureButton.addEventListener('click', function(event){
  ...
  videoPlayer.srcObject.getVideoTracks().forEach(function(tracks){
    track.stop();
  });
...
function openCreatePostModal() {
  ...
  setTimeout(() => {
    createPostArea.style.display = "translateY(100vh)";
